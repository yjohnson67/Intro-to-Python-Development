...
print(f"Hello {name}!  Welcome to this adventure, good luck! Hint: You can win at this game, your choice depends on it!")
start = input("Would you like to take a risk and play? (yes/no) ").lower()
if start == "yes":
    ...
    if setting == "jungle":  
        ...
        response = input("but he has been gone for quit some time now...Follow him or wait here? ").lower()
        if response == "follow":
            choice = input("You know he headed towards the river, there is a canoe nearby. Would you like to follow him by walking or canoe (walk/canoe?)  ").lower()
            if choice == "walk":
        ...
        if response == "wait":
            ...
            choice = input("Keep waiting or follow him? ").lower()
            if choice == "wait":
    ...
    if setting == "desert":
        ...
        response = input("But he has been gone for a while now...Follow him or wait here? ").lower()
        if response == "follow":
            choice = input("You saw him head towards the Pyramids, there's a camel nearby.  Would you like to follow him by \nwalking or riding the camel? (please respond with one of these options walk/camel) ").lower()
            if choice == "walk":
