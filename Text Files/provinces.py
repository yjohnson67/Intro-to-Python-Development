...
"""
Write a Python program named that reads the contents
...
def main():
    ...
    provinces_list = read_list("Text Files\provinces.txt")
...
def main():
    # Read the contents of a text file named
    # provinces.txt into a list named provinces_list.
    file_path = os.path.join("Text Files", "provinces.txt")
    with open(file_path, "r") as f:
        provinces_list = [line.strip() for line in f.readlines()]
