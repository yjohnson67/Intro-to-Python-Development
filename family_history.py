...
def print_death_age(people_dict):
    ...
    for _ in people_dict:
        ...
        birth_year = int(data[BIRTH_YEAR_INDEX])
        death_year = int(data[DEATH_YEAR_INDEX])
...
def print_marriages(marriages_dict, people_dict):
    ...
    for _ in marriages_dict:
        marriages = marriages_dict[_]
        marriage_year = int(marriages[WEDDING_YEAR_INDEX])
        husband_key = marriages[HUSBAND_KEY_INDEX]
        wife_key = marriages[WIFE_KEY_INDEX]
        man = people_dict[husband_key]
        woman = people_dict[wife_key]
        man_name = man[NAME_INDEX]
        woman_name = woman[NAME_INDEX]
        man_birth_year = int(man[BIRTH_YEAR_INDEX])
        woman_birth_year = int(woman[BIRTH_YEAR_INDEX])
        man_age_at_marriage = marriage_year - man_birth_year
        woman_age_at_marriage = marriage_year - woman_birth_year
        print(f"{man_name} {man_age_at_marriage} > {marriage_year} < {woman_name} {woman_age_at_marriage}")
